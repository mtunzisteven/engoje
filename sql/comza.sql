...
(37, 164, 2, 1, '2021-09-29 05:20:30', '/zalisting/images/2_59f598a6-91db-4f25-b342-f58d68b1e791_1024x1024@2x-tn.jpg');
...
(145, 1, '165,Baby Romper,red,70,1,164,Minnie Dress,red,30,2,167,Baby Romper,gold,90,1', 1, 'processing', NULL, '2021-09-17 08:49:51', 4, 280),
(147, 1, '165,Baby Romper,red,70,1,164,Minnie Dress,red,30,2,167,Baby Romper,gold,90,1', 1, 'processing', NULL, '2021-09-28 14:54:30', 4, 280),
(151, 1, '164,Minnie Dress,red,30,2,164,Minnie Dress,red,30,2', 2, 'processing', NULL, '2021-09-29 10:21:08', 2, 130);
...
(10, 'm', 'mm', 'm@gmail.com', NULL, '$2y$10$0dsUT68qB0Liyw0yjU3n7eU4SsjcZ.zjMZWj4Joa/VNCorcjQ2sBy', '2021-09-30 13:22:59', 1);
...
--
ALTER TABLE `cart_items`
  MODIFY `cart_itemId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `temp_accounts`
  MODIFY `temp_accountId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
