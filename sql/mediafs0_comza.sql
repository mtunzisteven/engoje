...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2021 at 02:50 PM
...
INSERT INTO `cart_items` (`cart_itemId`, `product_entryId`, `cart_item_qty`, `userId`, `imagePath_tn`, `dateAdded`) VALUES
(129, 186, 2, 1, '/zalisting/images/leopard print hood1-tn.jpg', '2021-06-23 02:20:12');
...
INSERT INTO `checkout` (`checkoutId`, `userId`, `checkoutDate`) VALUES
(146, 1, '2021-06-24 12:30:20');
...
(181, 316, 6, 1, 12, 230, 'PAJ-JKU-J13', 2),
(182, 316, 5, 3, 12, 230, 'PAJ-JKU-J14', 6),
(183, 316, 5, 8, 12, 230, 'PAJ-JKU-J15', 5),
(184, 316, 6, 8, 12, 230, 'PAJ-JKU-J16', 1),
(185, 317, 5, 6, 13, 210, 'JUH2-VX2L-M1', 5),
(186, 317, 5, 8, 13, 210, 'JUH2-VX2L-M2', 9),
(187, 318, 1, 3, 9, 95, 'PAH1-KL44-22L', 18);
...
INSERT INTO `shipping_method` (`shipping_methodId`, `name`, `shipper`, `period`, `price`) VALUES
...
INSERT INTO `wishlist_items` (`wishlistId`, `userId`, `product_entryId`, `imagePath_tn`, `dateAdded`) VALUES
(70, 1, 187, '/zalisting/images/beanieSet-tn.jfif', '2021-06-22 06:39:17');
...
ALTER TABLE `checkout`
  ...
  ADD KEY `FK_checkout_user` (`userId`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `FK_orders_product_entry` (`product_entryId`),
  ADD KEY `FK_orders_shipping_method` (`shipping_methodId`);
...
ALTER TABLE `shipping_method`
  ADD PRIMARY KEY (`shipping_methodId`);
...
--
ALTER TABLE `cart_items`
  MODIFY `cart_itemId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `checkout`
  MODIFY `checkoutId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=147;
...
--
ALTER TABLE `shipping_method`
  MODIFY `shipping_methodId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `wishlist_items`
  MODIFY `wishlistId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `checkout`
  ADD CONSTRAINT `FK_checkout_user` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `FK_orders_product_entry` FOREIGN KEY (`product_entryId`) REFERENCES `product_entry` (`product_entryId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_orders_shipping_method` FOREIGN KEY (`shipping_methodId`) REFERENCES `shipping_method` (`shipping_methodId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
